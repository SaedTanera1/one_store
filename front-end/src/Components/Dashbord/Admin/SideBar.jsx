...
import { HomeOutlined, ProductionQuantityLimits } from "@mui/icons-material";
...
import image from "../NaveDashbord/logo.png";
...
const Array1 = [
  { text: "Dashboard", icon: <HomeOutlinedIcon />, path: "/Admin/admin" },
  { text: "Product", icon: <ProductionQuantityLimits />, path: "/Admin/ProductAdmin" },
